...
class LetoRedis(metaclass=SingletonMeta):
    ...
    STOCK_REBUILD_KEY = "stock_rebuild_lock_{}"

    DETAIL_REBUILD_KEY = "detail_rebuild_lock_{}"
                    ...
                    async with AsyncSessionFactory() as session:
                        ...
                        async with session.begin():
                            ...
                            if not seckill:
                                ...
                                print(f"detail缓存：DB查无此活动 seckill_id={seckill_id}")
                            ...
                            if ex > 0:
                                ...
                                print(f"detail缓存：活动已结束，不写入缓存 seckill_id={seckill_id}")
