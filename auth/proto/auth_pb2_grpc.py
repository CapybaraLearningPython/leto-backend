...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendSMSCode = channel.unary_unary(
                ...
                request_serializer=auth__pb2.SendSMSCodeRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.Login = channel.unary_unary(
                '/AuthService/Login',
                request_serializer=auth__pb2.LoginRequest.SerializeToString,
                response_deserializer=auth__pb2.AuthInfoResponse.FromString,
                _registered_method=True)
        self.UpdateAccessToken = channel.unary_unary(
                '/AuthService/UpdateAccessToken',
                request_serializer=auth__pb2.UpdateAccessTokenRequest.SerializeToString,
                response_deserializer=auth__pb2.UpdateAccessTokenResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendSMSCode': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.SendSMSCodeRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'Login': grpc.unary_unary_rpc_method_handler(
                    servicer.Login,
                    request_deserializer=auth__pb2.LoginRequest.FromString,
                    response_serializer=auth__pb2.AuthInfoResponse.SerializeToString,
            ),
            'UpdateAccessToken': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateAccessToken,
                    request_deserializer=auth__pb2.UpdateAccessTokenRequest.FromString,
                    response_serializer=auth__pb2.UpdateAccessTokenResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def SendSMSCode(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/AuthService/SendSMSCode',
            auth__pb2.SendSMSCodeRequest.SerializeToString,
    ...
    def Login(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.AuthInfoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateAccessToken(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/AuthService/UpdateAccessToken',
            auth__pb2.UpdateAccessTokenRequest.SerializeToString,
            auth__pb2.UpdateAccessTokenResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
